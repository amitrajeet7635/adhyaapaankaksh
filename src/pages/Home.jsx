    ...
    return (
        <>
            <section id='home' className='pt-[2.5rem]' >
                ...
                <img className='absolute top-[-500px] sm:top-[39%] left-[41%] z-[1] lg:left-[43%] lg:top-[46%] lg:h-[40px] xl:h-[60px] xl:top-[50%] 2xl:top-[48%] 2xl:left-[40%] 3xl:top-[50%] 3xl:h-[63px] 3xl:left-[42%]' src="/flask.png" alt="flask" />
                <img className='absolute top-[-500px] sm:top-[70%] z-[1] lg:h-[150px] lg:top-[75%] xl:top-[83%] 2xl:top-[75%] 3xl:top-[75%] 3xl:h-[200px]' src="/Globe.png" alt="globe-img" />


                <div className="hero-section mt-[10rem] flex flex-col gap-[2rem] min-h-[100vh] lg:mt-[5rem] lg:grid lg:grid-cols-[1.3fr_1fr] grid-flow-col m-[30px] content-center lg:min-h-[80vh] xl:h-[100vh]">
                    ...
                    <div className="lg:col-start-1 w-[100%] h-[40vh]">
                        <div className="  flex flex-col gap-4 items-center lg:items-start">
                            ...
                            <HashLink smooth to="/#courses" className={`bg-[#EC1F26] font-montserrat font-bold text-[15px] text-white px-4 py-2 rounded-[20px] w-[230px] h-[50px] sm:w-[300px] sm:h-[60px] sm:text-[18px] lg:h-[64px] lg:text-[22px] content-center  3xl:w-[400px] 3xl:h-[80px] 3xl:text-[27px] z-[10] ${ isActive('/#courses')}`}>
                            Discover Our Courses </HashLink>
                        </div>
                    </div>
            ...
            <section id='about' ref={aboutRef} className='min-h-[100vh] w-[100%] pt-[2.5rem] overflow-hidden'>
                <div className='flex flex-col items-center m-8'>
                    <p className='text-[60px] font-montserrat font-bold sm:text-[70px] 2xl:text-[100px] 3xl:text-[120px]'>About Us</p>
                    <div className='flex flex-col items-center lg:grid lg:grid-cols-2 gap-0'>
                        <img
                            className={`place-self-center w-[100%] sm:w-[300px] lg:w-[600px] 3xl:w-[600px] rounded-[3rem] transform transition-all duration-700 ease-out lg:${isVisible ? "translate-x-0 opacity-100" : "-translate-x-20 opacity-0"}`}
                            src="/nikita mam.svg"
                            alt="mam"
                        />
            ...
            <section id='achievers' className='min-h-[90vh] sm:min-h-[150vh] lg:mt-[5rem] xl:min-h-[200vh] 2xl:min-h-[100vh] 3xl:min-h-[150vh]'>
            ...
            <section id="testimonials" className='flex flex-col  h-[70vh] sm:h-[110vh] md:h-[110vh] lg:h-[80vh] xl:h-[90vh] 2xl:h-[80vh]'>
