    ...
    return (
        <>
            <section id="PrivacyPolicy">
                <div class="bg-[#FFFFF7]">
                    <div class="container mt-[4.5rem] mx-auto px-4 py-8">
                        <h1 class="text-3xl font-bold mb-4 font-montserrat">Privacy Policy</h1>
                        ...
                        <h2 class="text-2xl font-bold mb-2 font-montserrat" >Information We Collect</h2>

                        <p class="mb-4 font-poppins">
                            We may collect the following information:
                        </p>

                        <ul class="list-disc list-inside mb-4 font-poppins">
                            <li>Your name and contact information</li>
                            <li>Demographic information</li>
                            <li>Other information relevant to customer surveys and/or offers</li>
                        </ul>

                        <h2 class="text-2xl font-bold mb-2 font-montserrat">How We Use the Information</h2>
                        ...
                        <h2 class="text-2xl font-bold mb-2 font-montserrat">Security</h2>
                        ...
                        <h2 class="text-2xl font-bold mb-2 font-montserrat">Cookies</h2>
                        ...
                        <h2 class="text-2xl font-bold mb-2 font-montserrat">Links to Other Websites</h2>
                        ...
                        <h2 class="text-2xl font-bold mb-2 font-montserrat">Controlling Your Personal Information</h2>
